...
class MainWindow(QMainWindow):
    ...
    def setup_ui(self):
        ...
        self.activation_view = ActivationView(self.db, self)
        ...
        self.tabs.addTab(self.activation_view, self.load_icon("analyze.png"), "Ativações")
    ...
    def on_event_selected(self, event_id):
        ...
        self.activation_view.set_event(event_id)
